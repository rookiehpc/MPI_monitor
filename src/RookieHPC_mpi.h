...
int RookieHPC_MPI_Type_create_hindexed_block(int block_count, int block_length, MPI_Aint* displacements, MPI_Datatype old_datatype, MPI_Datatype* new_datatype, char* file, int line, const char* args);
...
/// Redirects calls from MPI_Group_union to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
#define MPI_Group_union(...) RookieHPC_MPI_Group_union(__VA_ARGS__, __FILE__, __LINE__, #__VA_ARGS__)
...
/// Redirects calls from MPI_Test_cancelled to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
#define MPI_Test_cancelled(...) RookieHPC_MPI_Test_cancelled(__VA_ARGS__, __FILE__, __LINE__, #__VA_ARGS__)
...
/// Redirects calls from MPI_Type_create_hindexed to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
#define MPI_Type_create_hindexed(...) RookieHPC_MPI_Type_create_hindexed(__VA_ARGS__, __FILE__, __LINE__, #__VA_ARGS__)
/// Redirects calls from MPI_Type_create_hindexed_block to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
#define MPI_Type_create_hindexed_block(...) RookieHPC_MPI_Type_create_hindexed_block(__VA_ARGS__, __FILE__, __LINE__, #__VA_ARGS__)
/// Redirects calls from MPI_Type_create_hvector to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
#define MPI_Type_create_hvector(...) RookieHPC_MPI_Type_create_hvector(__VA_ARGS__, __FILE__, __LINE__, #__VA_ARGS__)
/// Redirects calls from MPI_Type_create_indexed_block to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
#define MPI_Type_create_indexed_block(...) RookieHPC_MPI_Type_create_indexed_block(__VA_ARGS__, __FILE__, __LINE__, #__VA_ARGS__)
/// Redirects calls from MPI_Type_create_struct to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
...
/// Redirects calls from MPI_Type_get_extent to the RookieHPC version and collects the file name as well as the line at which the MPI call is issued
