...
enum RookieHPC_MPI_message_type_t { /// The message is sent about MPI_Abort
                                    ...
                                    ROOKIEHPC_MESSAGE_COMM_GROUP,
                                    /// The message is sent about MPI_Comm_rank
                                    ROOKIEHPC_MESSAGE_COMM_RANK,
...
{
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_BEFORE, ROOKIEHPC_MESSAGE_COMM_GROUP, file, line, args);
    int result = MPI_Comm_group(communicator, group);
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_AFTER, ROOKIEHPC_MESSAGE_COMM_GROUP, file, line, args);
    return result;
}

int RookieHPC_MPI_Comm_rank(MPI_Comm communicator, int* rank, char* file, int line, const char* args)
{
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_BEFORE, ROOKIEHPC_MESSAGE_COMM_RANK, file, line, args);
    int result = MPI_Comm_rank(communicator, rank);
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_AFTER, ROOKIEHPC_MESSAGE_COMM_RANK, file, line, args);
    return result;
}

int RookieHPC_MPI_Comm_set_name(MPI_Comm communicator, const char* name, char* file, int line, const char* args)
{
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_BEFORE, ROOKIEHPC_MESSAGE_COMM_SET_NAME, file, line, args);
    int result = MPI_Comm_set_name(communicator, name);
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_AFTER, ROOKIEHPC_MESSAGE_COMM_SET_NAME, file, line, args);
    return result;
}
...
{
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_BEFORE, ROOKIEHPC_MESSAGE_TYPE_CREATE_INDEXED_BLOCK, file, line, args);
    int result = MPI_Type_create_indexed_block(block_count, block_length, displacements, old_datatype, new_datatype);
    RookieHPC_monitoring_message(ROOKIEHPC_TEMPORALITY_AFTER, ROOKIEHPC_MESSAGE_TYPE_CREATE_INDEXED_BLOCK, file, line, args);
    return result;
}
